...
(cl:defmethod cl:initialize-instance :after ((m <Move-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Move-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_msgs-srv:<Move-request> is deprecated: use robot_msgs-srv:Move-request instead.")))
...
(cl:defmethod mvvelo-val ((m <Move-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_msgs-srv:mvvelo-val is deprecated.  Use robot_msgs-srv:mvvelo instead.")
  (mvvelo m))

(cl:ensure-generic-function 'mvacc-val :lambda-list '(m))
(cl:defmethod mvacc-val ((m <Move-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_msgs-srv:mvacc-val is deprecated.  Use robot_msgs-srv:mvacc instead.")
  (mvacc m))

(cl:ensure-generic-function 'coord_mode-val :lambda-list '(m))
(cl:defmethod coord_mode-val ((m <Move-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_msgs-srv:coord_mode-val is deprecated.  Use robot_msgs-srv:coord_mode instead.")
  (coord_mode m))

(cl:ensure-generic-function 'index-val :lambda-list '(m))
(cl:defmethod index-val ((m <Move-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_msgs-srv:index-val is deprecated.  Use robot_msgs-srv:index instead.")
  (index m))
...
(cl:defmethod cl:initialize-instance :after ((m <Move-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Move-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_msgs-srv:<Move-response> is deprecated: use robot_msgs-srv:Move-response instead.")))
