...
(cl:defmethod cl:initialize-instance :after ((m <ServoL>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ServoL)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aubo_robot-msg:<ServoL> is deprecated: use aubo_robot-msg:ServoL instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <ServoL>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aubo_robot-msg:pose-val is deprecated.  Use aubo_robot-msg:pose instead.")
  (pose m))
